module.exports = function(e) {
        ...
        function t(e) {
            ...
            return n.goTo = function(e) {
                ...
                o && n._resetInterval(), e === s.POSITION.NEXT ? a === i.default.Children.count(r) - 1 ? n.setState({
                    ...
                    current_index: a + 1
                }, ()=>n.props.afterChange(a+1)) : e === s.POSITION.PREV && (0 === a ? n.setState({
                    current_index: i.default.Children.count(r) - 1
                }, ()=>n.props.afterChange( i.default.Children.count(r) - 1)) : n.setState({
                    current_index: a - 1
                },()=>n.props.afterChange(a-1)))
    ...
    Object.defineProperty(t, "__esModule", {
      ...
      if(e==r.POSITION.NEXT || e==r.POSITION.PREV)
        return 0.5
